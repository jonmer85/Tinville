...
class ProductCreationForm(forms.ModelForm):
    ...
    price = forms.DecimalField(decimal_places=2, max_digits=12, required=True)
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['price'] \
            = forms.DecimalField(decimal_places=2, max_digits=12, initial=self.get_value_if_in_edit_mode('price', None),required=True)

...
class SendOrderMixinTests(TestCase):
    ...
    def Send_Valid_New_Order_Email_Test(self):
        ...
        self.assertEqual(email.body_html, "<html><div>Hello,</div><p>A new order 2-10011 is available.<br><a href='http://testserver/dashboard/orders/2-10011/'>Click here</a> to view your order.</p><p>The order contains:</p><ul><li>Dummy title - quantity: 1</li></ul><p></html>", "Because the html body should be equal")
from custom_oscar.apps.catalogue import views as TinvilleCatalogueViews
...
class BaseCatalogueApplication(Application):
    name = 'catalogue'
    detail_view = TinvilleCatalogueViews.ProductDetailView
    ...
    def get_urls(self):
        ...
        urlpatterns += [
            ...
            # url(r'^(?Pd<shop_slug>[\w-]+)/(?P<item_slug>[\w-]+)/$',
